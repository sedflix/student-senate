...
var links = {
    ...
    "Explore our Database": '<iframe class="airtable-embed" src="https://airtable.com/embed/shrCcWmgG9WheZ1eQ?backgroundColor=teal&layout=card" frameborder="0" onmousewheel="" width="100%" height="100%" style="background: transparent; border: 1px solid #ccc;"></iframe>',
